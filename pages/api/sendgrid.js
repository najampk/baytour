...
async function sendEmail(req, res) {
  try {
    ...
    await sendgrid.send({
      ...
      subject: `[Lead Baytour.net - Inquiry] : ${req.body.subject}`,
      ...
      <table>
        ...
        <tr style="font-size:18px; font-weight:bold; padding-bottom:10px;"><td style=" text-align:right;">Subject :</td><td style="text-transform:capitalize; text-align:left;color:brown;padding-left:5px;">${req.body.subject} </td></tr>
        <tr style="font-size:18px; "><td style="width:10%; text-align:right; font-weight:bold; vertical-align:top;">Message :</td><td style="text-transform:capitalize; text-align:left;padding-left:5px;">${req.body.message} </td></tr>
