...
<xsl:stylesheet version="2.0" xmlns:html="http://www.w3.org/TR/REC-html40" xmlns:image="http://www.google.com/schemas/sitemap-image/1.1" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		...
		<div id="content">
			<h1>XML Sitemap</h1>
			<p className="expl">
				Generated by <a href="https://baytour.net" target="_blank">Baytour.net</a>, this is an XML Sitemap, meant for consumption by search engines.<br />
			...
			<xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &gt; 0">
				...
				<table id="sitemap" cellpadding="3">
					...
					<xsl:for-each select="sitemap:sitemapindex/sitemap:sitemap">
						...
						<tr>
							<td>
								<a href="https://baytour.net/%7B$sitemapURL%7D"><xsl:value-of select="sitemap:loc"/></a>
							</td>
							<td>
					...
					<xsl:for-each select="sitemap:urlset/sitemap:url">
						<tr>
							<td>
								...
								<!-- <a:href:value-of select="sitemap:loc" >
									<xsl:value-of select="sitemap:loc"/>
								</a> -->
									<xsl:element name="a">
